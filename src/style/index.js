...
const allLayers = [
    ...
    objectIconLayerFactory('busstop', { coefMin: 0.85, coefMax: 1 }),
    objectIconLayerFactory('cross', { coefMin: 0.85, coefMax: 1 }),
    objectIconLayerFactory('chapel', { coefMin: 0.85, coefMax: 1 }),
    objectIconLayerFactory('church', { coefMin: 0.85, coefMax: 1 }),
    objectIconLayerFactory('fuelstation', { coefMin: 0.85, coefMax: 1 }),
    objectIconLayerFactory('hospital', { coefMin: 0.85, coefMax: 1 }),
    objectIconLayerFactory('lighthouse', { coefMin: 0.85, coefMax: 1 }),
    objectIconLayerFactory('power', { coefMin: 0.85, coefMax: 1 }),
    objectIconLayerFactory('powersolar', { coefMin: 0.85, coefMax: 1 }),
    objectIconLayerFactory('powerwave', { coefMin: 0.85, coefMax: 1 }),
    objectIconLayerFactory('powerwind', { coefMin: 0.85, coefMax: 1 }),
    objectIconLayerFactory('quay', { coefMin: 0.85, coefMax: 1 }),
    objectIconLayerFactory('shipwreck', { coefMin: 0.85, coefMax: 1 }),
    objectIconLayerFactory('watertower', { coefMin: 0.85, coefMax: 1 }),
    objectIconLayerFactory('transmitter', { coefMin: 0.85, coefMax: 1 }),
